...
export const DRAWING_UPLOAD = 'DRAWING_UPLOAD';
export const DRAWING_NAV = 'DRAWING_NAV';
export const SCALING_0 = 'SCALING_0';
export const SCALING_1 = 'SCALING_1';
export const SCALING_2 = 'SCALING_2';
export const ROOM_ADD = 'ROOM_ADD';
export const ROOM_0 = 'ROOM_0';
export const ROOM_1 = 'ROOM_1';
export const PANEL_0 = 'PANEL_0';
export const PANEL_1 = 'PANEL_1';
export const ROOM_HOVER = 'ROOM_HOVER';
export const ROOM_SELECT = 'ROOM_SELECT';
export const PANEL_ADD = 'PANEL_ADD';
export const PANEL_HOVER = 'PANEL_HOVER';
